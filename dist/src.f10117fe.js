...
function () {
  ...
  Attributes.prototype.getAllProps = function () {
    return this.data;
  };
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      if (_this.eventsObj[eventName]) {
        _this.eventsObj[eventName].push(callback);
      } else {
        _this.eventsObj[eventName] = [callback];
      } // his
    ...
    this.trigger = function (eventName) {
      var handlers = _this.eventsObj[eventName];
...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collection_1.Collections("http://localhost:3000/users", function (json) {
...
function () {
  ...
  View.prototype.mapRegions = function (fragment) {
    ...
    for (var _i = 0, _a = Object.keys(regionsMap); _i < _a.length; _i++) {
      var key = _a[_i];
...
var Collection_1 = require("./models/Collection"); // const collection = User.buildUserCollection();
// collection.on("change", () => {
//   console.log({ collection });
// });
// collection.fetch();
// const user = User.buildUser({ name: "Beello", age: 30 });
...
var users = new Collection_1.Collections("http://localhost:3000/users", function (json) {
